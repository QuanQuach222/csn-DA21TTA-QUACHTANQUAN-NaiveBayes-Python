import pandas as pd
df = pd.read_csv(r'D:\Đồ án CSN Naivebayes\data.csv')
# Tính P(c1) và P(c2)
Pc1 = df[df['Column5'] == 'Yes'].shape[0] / df.shape[0]
Pc2 = df[df['Column5'] == 'No'].shape[0] / df.shape[0]
# Tính P(Age=Young|c1), P(Income=Meidum|c1), P(Student=Yes|c1), P(Credit_Rating=Fair|c1)
PAgeYoung_c1 = df[(df['Column1'] == 'Young') & (df['Column5'] == 'Yes')].shape[0] / df[df['Column5'] == 'Yes'].shape[0]
PIncomeMedium_c1 = df[(df['Column2'] == 'Medium') & (df['Column5'] == 'Yes')].shape[0] / df[df['Column5'] == 'Yes'].shape[0]
PStudentYes_c1 = df[(df['Column3'] == 'Yes') & (df['Column5'] == 'Yes')].shape[0] / df[df['Column5'] == 'Yes'].shape[0]
PCreditRatingFair_c1 = df[(df['Column4'] == 'Fair') & (df['Column5'] == 'Yes')].shape[0] / df[df['Column5'] == 'Yes'].shape[0]
# Tính P(Age=Young|c2), P(Income=Medium|c2), P(Student=Yes|c2), P(Credit_Rating=Fair|c2)
PAgeYoung_c2 = df[(df['Column1'] == 'Young') & (df['Column5'] == 'No')].shape[0] / df[df['Column5'] == 'No'].shape[0]
PIncomeMedium_c2 = df[(df['Column2'] == 'Medium') & (df['Column5'] == 'No')].shape[0] / df[df['Column5'] == 'No'].shape[0]
PStudentYes_c2 = df[(df['Column3'] == 'Yes') & (df['Column5'] == 'No')].shape[0] / df[df['Column5'] == 'No'].shape[0]
PCreditRatingFair_c2 = df[(df['Column4'] == 'Fair') & (df['Column5'] == 'No')].shape[0] / df[df['Column5'] == 'No'].shape[0]
#tính P(x|c1) 
...
most_probable_class = 'c1' if Pc1_x > Pc2_x else 'c2'
print("Suy ra x sẽ mua máy tính" if most_probable_class == 'c1' else "Suy ra x sẽ không mua máy tính")
